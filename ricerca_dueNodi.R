...
ricerca_performance_excel <- read_excel("ricerca_2_nodi.xlsx")
...
plot(data$date, data$avg_response, main = "Ricerca e navigazione risultati",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Ricerca e navigazione risultati",
