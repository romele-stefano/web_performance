...
catalog_performance_excel <- read_excel("catalog_performance_2_nodi.xlsx")
...
plot(data$date, data$avg_response, main = "Performance Catalogo",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance Catalogo",
