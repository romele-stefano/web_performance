...
ricerca_performance_excel <- read_excel("ricerca_nodo1.xlsx")
...
plot(data$date, data$avg_response, main = "Ricerca e navigazione risultati - Nodo 1",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Ricerca e navigazione risultati - Nodo 1",
