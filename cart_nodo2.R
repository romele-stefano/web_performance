...
cart_performance_excel <- read_excel("cart_performance_nodo2.xlsx")
...
plot(data$date, data$avg_response, main = "Performance Carrello - Nodo 2",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance Carrello - Nodo 2",
