...
catalog_performance_excel <- read_excel("catalog_performance_nodo_1.xlsx")
data <- as.data.frame(catalog_performance_excel)
...
plot(data$date, data$avg_response, main = "Performance Catalogo - Nodo 1",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance Catalogo - Nodo 1",
