...
promo_performance_excel <- read_excel("promoVolantino_nodo2.xlsx")
...
plot(data$date, data$avg_response, main = "Performance promo e volantino - Nodo 2",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance promo e volantino - Nodo 2",
