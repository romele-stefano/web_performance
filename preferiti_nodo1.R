...
preferiti_performance_excel <- read_excel("preferiti_nodo1.xlsx")
...
plot(data$date, data$avg_response, main = "Preferiti - Nodo 1",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Preferiti - Nodo 1",
