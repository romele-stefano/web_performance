...
catalog_performance_excel <- read_excel("catalog_performance_nodo_2.xlsx")
...
plot(data$date, data$avg_response, main = "Performance Catalogo - Nodo 2",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance Catalogo - Nodo 2",
