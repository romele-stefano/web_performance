...
promo_performance_excel <- read_excel("promoVolantino_2_nodi.xlsx.xlsx")
...
plot(data$date, data$avg_response, main = "Performance promo e volantino",
...
plot(final_data$id, final_data$avg_response, type = "l", main = "Performance promo e volantino",
